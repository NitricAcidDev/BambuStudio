...
#define SELECT_ALL_OPTION_COLOUR wxColour("#8A00D4")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bg_col(std::pair<wxColour, int>(wxColour(240, 219, 253), StateColor::Pressed), std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Hovered),
                            std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Normal));

    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(138, 0, 212), StateColor::Pressed), std::pair<wxColour, int>(wxColour(138, 0, 212), StateColor::Hovered),
