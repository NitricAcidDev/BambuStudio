...
StateColor ok_btn_bg(std::pair<wxColour, int>(Slic3r::GUI::Theme::accentPressed(), StateColor::Pressed),
    ...
    : DPIDialog(parent, id, title, pos, size, style), m_style_manager(style_manager)
{
    ...
    StateColor       ok_btn_bd(std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Normal));
