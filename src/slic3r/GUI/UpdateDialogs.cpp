    ...
    : DPIDialog(wxGetApp().mainframe, wxID_ANY, _L("Configuration update"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
{
	...
	StateColor btn_bg_green(std::pair<wxColour, int>(UpdateDialogsThemeGreenPressed(), StateColor::Pressed),
                            std::pair<wxColour, int>(UpdateDialogsThemeGreenHovered(), StateColor::Hovered), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
