...
void ExtrusionCalibration::create()
{
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentPressed(), StateColor::Pressed), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentHovered(), StateColor::Hovered),
        std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Normal));
    m_button_cali->SetBackgroundColor(m_btn_bg_green);
    m_button_cali->SetFont(Label::Body_13);
    m_button_cali->SetBorderColor({ std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Enabled) });
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(Slic3r::GUI::Theme::accentPressed(), StateColor::Pressed), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentHovered(), StateColor::Hovered),
        std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Normal));
    m_cali_cancel->SetBackgroundColor(m_btn_bg_green);
    m_cali_cancel->SetBorderColor(Slic3r::GUI::Theme::accentColor());
    ...
    m_button_save_result->SetBorderColor(Slic3r::GUI::Theme::accentColor());
