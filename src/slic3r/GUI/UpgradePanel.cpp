...
static const wxColour TEXT_NORMAL_CLR = Slic3r::GUI::Theme::accentColor();
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentPressed(), StateColor::Pressed),
                      std::pair<wxColour, int>(Slic3r::GUI::Theme::accentHovered(), StateColor::Hovered), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Enabled),
                      std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Enabled));
