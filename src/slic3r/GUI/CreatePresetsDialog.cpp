...
#define SELECT_ALL_OPTION_COLOUR Slic3r::GUI::Theme::accentColor()
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Pressed), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Hovered),
