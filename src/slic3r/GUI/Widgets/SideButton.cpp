    ...
    , state_handler(this)
{
    ...
    border_color.append(Slic3r::GUI::Theme::getThemeColor("side_button.border.normal"), StateColor::Normal);
    ...
    background_color.append(Slic3r::GUI::Theme::getThemeColor("side_button.bg.normal"), StateColor::Normal);
