...
static wxColour BonjourThemeGreenHovered() {
    auto *app = dynamic_cast<Slic3r::GUI::GUI_App*>(&Slic3r::GUI::wxGetApp());
    if (app && app->IsMainLoopRunning()) {
...
static wxColour BonjourThemeGreenPressed() {
    auto *app = dynamic_cast<Slic3r::GUI::GUI_App*>(&Slic3r::GUI::wxGetApp());
    if (app && app->IsMainLoopRunning()) {
	...
	, tech(tech)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(BonjourThemeGreenPressed(), StateColor::Pressed), std::pair<wxColour, int>(BonjourThemeGreenHovered(), StateColor::Hovered),
                            std::pair<wxColour, int>(BonjourThemeGreen(), StateColor::Normal));
