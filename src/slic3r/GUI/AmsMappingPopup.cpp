...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(Slic3r::GUI::Theme::accentColor()));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(Slic3r::GUI::Theme::accentPressed(), StateColor::Pressed), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentColor(), StateColor::Normal));
