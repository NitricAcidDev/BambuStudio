...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(107, 11, 168), StateColor::Pressed),
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(107, 11, 168), StateColor::Pressed), std::pair<wxColour, int>(wxColour(168, 81, 220), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(138, 0, 212), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(138, 0, 212), StateColor::Normal));
