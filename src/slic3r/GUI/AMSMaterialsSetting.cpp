...
void AMSMaterialsSetting::create()
{
    ...
    m_button_confirm->SetBorderColor(Slic3r::GUI::Theme::accentColor());
...
void AMSMaterialsSetting::create_panel_normal(wxWindow* parent)
{
    ...
    m_readonly_filament->SetBorderColor(StateColor(std::make_pair(Slic3r::GUI::Theme::getThemeColor("ams_material.border.focused"), (int)StateColor::Focused), std::make_pair(Slic3r::GUI::Theme::getThemeColor("ams_material.border.hovered"), (int)StateColor::Hovered),
        std::make_pair(Slic3r::GUI::Theme::getThemeColor("ams_material.border.focused"), (int)StateColor::Normal)));
