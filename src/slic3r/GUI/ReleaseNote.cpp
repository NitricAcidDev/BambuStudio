    ...
    : DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("Network plug-in update"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(ReleaseNoteThemeGreenPressed(), StateColor::Pressed), std::pair<wxColour, int>(ReleaseNoteThemeGreenHovered(), StateColor::Hovered),
    ...
    :DPIFrame(parent, id, title, pos, size, style)
{
    ...
    auto sizer_button = new wxBoxSizer(wxHORIZONTAL);
    btn_bg_green = StateColor(std::pair<wxColour, int>(ReleaseNoteThemeGreenPressed(), StateColor::Pressed), std::pair<wxColour, int>(ReleaseNoteThemeGreenHovered(), StateColor::Hovered),
        std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
void ConfirmBeforeSendDialog::edit_cancel_button_txt(const wxString& txt, bool switch_green)
{
    ...
    if (switch_green)
    {
        StateColor btn_bg_green(std::pair<wxColour, int>(ReleaseNoteThemeGreenPressed(), StateColor::Pressed),
                                std::pair<wxColour, int>(ReleaseNoteThemeGreenHovered(), StateColor::Hovered),
                                std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
{
    m_button_ok->Enable();
    StateColor btn_bg_green(std::pair<wxColour, int>(ReleaseNoteThemeGreenHovered(), StateColor::Pressed), std::pair<wxColour, int>(ReleaseNoteThemeGreenHovered(), StateColor::Hovered),
        std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
    m_button_ok->SetBackgroundColor(btn_bg_green);
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    m_test_right_msg->SetForegroundColour(ReleaseNoteThemeGreenHovered());
        ...
        wxCAPTION | wxCLOSE_BOX)
{
    ...
    StateColor btn_bg_green = StateColor(std::pair<wxColour, int>(ReleaseNoteThemeGreenHovered(), StateColor::Hovered), std::pair<wxColour, int>(ReleaseNoteThemeGreen(), StateColor::Normal));
    StateColor btn_bg_white(std::pair<wxColour, int>(wxColour(206, 206, 206), StateColor::Pressed), std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Hovered),
        std::pair<wxColour, int>(*wxWHITE, StateColor::Normal));
