    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(Slic3r::GUI::Theme::accentColor());
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(Slic3r::GUI::Theme::accentPressed(), StateColor::Pressed), std::pair<wxColour, int>(Slic3r::GUI::Theme::accentHovered(), StateColor::Hovered),
    ...
    m_statictext_finish->SetForegroundColour(Slic3r::GUI::Theme::accentColor());
